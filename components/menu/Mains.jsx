...
const menuData = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Freshly baked pizza topped with juicy tomatoes, aromatic basil, and savory tofu",
      ...
      },
      {
        ...
        title: "Lively Layers",
        description: "classic flavors of tomato and basil on this lighter pizza with 50% less vegan cheese",
      ...
      },
      {
        ...
        title: "Pocket Pizza",
        description: "Crispy rolls filled with savory tomato sauce, melted vegan cheese, and savory pizza seasonings",
        buttonLabels: ["GF", "NF", "VG", "DF"],
        id:78
      },
      {
        ...
        description: "flavorful combination of juicy tomatoes, sweet bell peppers, and savory onions",
        buttonLabels: ["GF","VG", "DF"],
        id:79
      },
    ],
    ...
    items: [
      {
        ...
        title: "Tomato Tango",
        description: "Penne pasta coated in a rich, flavorful tomato marinara sauce with herbs",
        buttonLabels: ["GF", "VG", "DF"],
        id:52
      },
      {
        ...
        title: "Layered Love",
        description: "Lasagna layered with savory tomato sauce, fresh herbs, and creamy vegan cheese",
        buttonLabels: ["GF","VG", "DF"],
        id:53
      },
      {
        ...
        description: "Penne pasta smothered in Alfredo sauce, topped with vegan cheeses and herbs",
        buttonLabels: ["GF", "VG", "DF"],
        id:54
      },
      {
        ...
        title: "Green Gnocchi",
        description: "Gnocchi covered in a creamy spinach sauce with a touch of herbs, walnuts, and vegan cheese",
        buttonLabels: ["GF","VG", "DF"],
        id:80
      },
      {
        ...
        title: "Pesto Passion",
        description: "Farfalle pasta tossed in fragrant pesto, sprinkled with coconut shreds and fresh basil",
        buttonLabels: ["GF", "VG", "DF"],
        id:81
      },
    ],
    ...
    items: [
      {
        ...
        description: "creamy and flavorful risotto bursting with the earthy goodness of mushrooms",
        buttonLabels: ["GF", "VG", "DF"],
        id:55
      },
      {
    ...
    items: [
      {
        ...
        description: "flavorful fried rice dish with fragrant scallions, vibrant carrots, and brown rice",
        buttonLabels: ["GF", "VG", "DF"],
        id:60
      },
      {
        ...
        title: "Chili Chomp",
        description: "bowl filled with spicy chili chickpeas, fresh lettuce, fragrant rice, and a side of wholesome grain bread",
        buttonLabels: ["GF","VG", "DF"],
        id:61
      },
      {
        ...
        title: "Creamy Cuddle",
        description: "creamy vegan cheese-covered tofu served alongside fluffy rice and vibrant broccoli florets",
        buttonLabels: ["GF", "VG", "DF"],
        id:62
      },
      {
        ...
        title: "Grain Greens",
        description: "satisfying bowl with hearty whole grain bread, spicy chili chickpeas, fragrant rice, and roasted brussel sprouts",
        buttonLabels: ["GF", "VG", "DF"],
        id:59
      },
    ],
